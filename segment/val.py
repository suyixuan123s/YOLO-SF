...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'F:/YOLO/yolov7-main/yolo/YOLOv7-Pytorch-Segmentation/runs/train-seg/yolov7x/exp12/weights/best.pt', help='model path(s)')
